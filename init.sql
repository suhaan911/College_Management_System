...
-- -----------------------------------------------------------
DROP VIEW IF EXISTS StudentResultView;
...
-- -----------------------------------------------------------
-- Stored Procedure: GetStudentResult
-- -----------------------------------------------------------
DROP PROCEDURE IF EXISTS GetStudentResult;
DELIMITER $$
...
-- -----------------------------------------------------------
-- Trigger: CheckMarks — prevent negative marks
-- -----------------------------------------------------------
DROP TRIGGER IF EXISTS CheckMarks_before_insert;
DROP TRIGGER IF EXISTS CheckMarks_before_update;
...
INSERT INTO Faculty (faculty_name, email, phone, dept_id, designation, joining_date, salary) VALUES
...
INSERT INTO Student (student_name, email, phone, dept_id, dob, gender, address, admission_year, semester) VALUES
...
INSERT INTO Course (course_name, course_code, dept_id, credits, semester, description) VALUES
...
INSERT INTO Class (course_id, faculty_id, class_date, start_time, end_time, room_no) VALUES
...
INSERT INTO Exam (exam_name, course_id, exam_date, total_marks, exam_type) VALUES
...
INSERT INTO Result (student_id, exam_id, marks_obtained, remarks) VALUES
